...
// Included in UIC.Core as MvvmLight doesn't support .Net Standard.
...
namespace Emilie.Core.MvvmLight
{
    ...
    public class CoreWeakFunc<TResult>
    {
        ...
        public CoreWeakFunc(Func<TResult> func, bool keepTargetAlive = false)
        ...
        public CoreWeakFunc(object target, Func<TResult> func, bool keepTargetAlive = false)
        {
