...
{
    /// <summary>
    /// An implementation of ILoadableResult that does not wrap content
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class ResultLoader : BindableBase, ILoadableResult, ILoadableResult1
    {
        public override Boolean AutomaticallyMarshalToDispatcher => false;
