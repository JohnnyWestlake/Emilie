...
namespace Emilie.UWP.Media
{
    ...
    {
        static Dictionary<Compositor, CompositionBackdropBrush> _backdropCache { get; } = new Dictionary<Compositor, CompositionBackdropBrush>();
        static Dictionary<Compositor, ExpressionAnimation> _centeringCache { get; } = new Dictionary<Compositor, ExpressionAnimation>();
        ...
        public static CompositionStoryboard CreateEntranceTheme<T>(
           ...
           TimeSpan? customDuration = null) where T : FrameworkElement
        {
            ...
            for (int i = 0; i < _items.Count; i++)
            {
                ...
                float _originalOpacity = (float)_opacitys[i];
