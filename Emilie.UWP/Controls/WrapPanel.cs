...
namespace Universal.Framework.Controls
{
    ...
    public class WrapPanel : Panel
    {
        ...
        /// </param>
        protected void ArrangeLine(int lineStart, int lineEnd, double? directDelta, double indirectOffset, double indirectGrowth)
        {
    ...
    internal static class NumericExtensions
    {
        ...
        public static bool AreClose(double left, double right)
        {
            ...
            Double closenessFactor = 0.005;

            if (diff > 0)
                return (diff <= closenessFactor);
            else
                return ((diff * -1) <= closenessFactor);
        }
