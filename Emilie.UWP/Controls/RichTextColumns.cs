...
namespace Universal.Framework.Controls
{
    /// <summary>
    ...
    /// 
    /// IScrollSnapPointsInfo implemented by Jay Bennett. 
    /// </remarks>
    ...
    public sealed class RichTextColumns : Panel, IScrollSnapPointsInfo
    {
        ...
        public List<RichTextBlockOverflow> OverflowColumns
        {
            get { return _overflowColumns; }
            set { _overflowColumns = value; }
        }
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            while (hasOverflow && maxWidth < availableSize.Width && this.ColumnTemplate != null)
            {
                ...
                //Logger.DebugLog("overflow index: " + overflowIndex);
            }
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            foreach (var child in Children)
            {
                ...
                snapWidth = child.DesiredSize.Width;
                snapHeight = child.DesiredSize.Height;
            }
            return new Size(maxWidth, maxHeight);
        }
        ...
        public IReadOnlyList<float> GetIrregularSnapPoints(Orientation orientation, SnapPointsAlignment alignment)
        {
            ...
            float first = (float)this.Margin.Left * -1f;
            result.Add(first);
            float current = 0f;

            foreach (RichTextBlockOverflow of in _overflowColumns)
            {
                float point = (float)of.DesiredSize.Width;
                current += point;
                result.Add(current - (float)of.Margin.Left);
            }
            return result;
        }
        ...
        public float GetRegularSnapPoints(Orientation orientation, SnapPointsAlignment alignment, out float offset)
        {
            ...
            if (orientation == Orientation.Horizontal)
                return (float)snapWidth;
            else
                return (float)snapHeight;
        }
