    ...
    public static class VisualTreeHelperExtensions
    {
        ...
        public static IEnumerable<DependencyObject> GetDescendants(this DependencyObject start, bool applyTemplate = false)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (applyTemplate && child is Control control)
        ...
        public static bool IsInVisualTree(this DependencyObject dob)
        {
            ...
            return Windows.UI.Xaml.Window.Current.Content != null && dob.GetAncestors().Contains(Window.Current.Content);
        }
        ...
        {
            if (relativeTo == null)
                relativeTo = (FrameworkElement)Windows.UI.Xaml.Window.Current.Content;
        ...
        public static Rect? GetBoundingRect(this FrameworkElement dob, FrameworkElement relativeTo = null)
        {
            if (relativeTo == null)
            {
                relativeTo = Windows.UI.Xaml.Window.Current.Content as FrameworkElement;
            }
