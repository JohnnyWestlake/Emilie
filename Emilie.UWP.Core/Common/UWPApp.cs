...
namespace Emilie.UWP
{
    ...
    public abstract class UWPApp : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            {
                // We're clearly a pre-launch here, so handle it.
                Logger.Log("Pre-launching");
                OnPrelaunch(args);
            }
            else
            {
        ...
        private void OnLaunch(IActivatedEventArgs args)
        {
            ...
            if (Windows.UI.Xaml.Window.Current.Content == null)
            {
#if DEBUG
        ...
        /// <summary>
        /// Called when the application is pre-launched. The window is not activated
        /// </summary>
        /// <param name="args"></param>
